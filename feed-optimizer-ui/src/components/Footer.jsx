...
import { FaFacebookF, FaTiktok, FaLine } from 'react-icons/fa';

export const Footer = ({ setView, setActiveSubView }) => {
    ...
    <footer className="bg-[#12171D] text-white py-16 text-left">
      <div className="container mx-auto px-6">
        ...
        <div className="pt-8 border-t border-white/10 text-white/30 text-sm text-center">
          © 2026 Byson Agri-Tech Co., Ltd. All rights reserved.
        </div>
      </div>
    </footer>
  );
